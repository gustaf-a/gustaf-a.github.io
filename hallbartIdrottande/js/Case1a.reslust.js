...
//PASTE JSON HERE:
	...
	{  	"ID": "10",
		"type":"info",
		"background":{"type":"image","url":"1_0.jpg"},
		"text":"<br><br><span class='normaltext'>Hur kan sex bli säkrare och <br class='nospacebr'/>mer lustfyllt?<br>Följ med på olika resor och upplev nya relationer!<br><span class='instruction_touch'>Svep till höger</span><span class='instruction_notouch'>Klicka på pilen till höger</span> för att gå vidare.</span><div class='lararhandledningslink'><a href='http://srhr.se/sites/default/files/Handledning_reslust.pdf' target='_blank'>Hämta Lärarhandledning här</a></div>",
        "justify":"center",
    ...
    {   "ID": "11",
        ...
        "title":"",
        "titlecenter":"true",
      "text":"<div class='extratopmargin'></div><span class='normaltext'>Reslust handlar om sex, relationer och känslor.<br>Du får välja vilka resor du vill följa med på och hur du tycker att personerna ska göra i olika situationer:<br> Hur känner de och vad kan göra deras äventyr skönare och säkrare?</span>",
